...
Console.WriteLine($"Bank Records Pattern Demo");
double currentBalance = 0.0;
var reader = new StringReader(bankRecords);

string? line; // nullable string of line
...
{
    Console.WriteLine($"Bank Records Pattern Demo has no data. Exiting...\n");
...
Console.WriteLine($"\nBank Records Pattern Demo - Transaction Records <Enums>");
currentBalance = 0.0;
...
Console.WriteLine($"\nBank Records Pattern Demo - Transaction Record Type <Type Pattern with Deposit and Withdrawal records>");
currentBalance = 0.0;
